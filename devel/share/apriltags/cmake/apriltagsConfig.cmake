...
if(NOT "/home/yifang/crazy_rl/src/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/yifang/crazy_rl/src/apriltags_ros/apriltags/include;/usr/include/eigen3;/usr/local/include/opencv;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yifang/crazy_rl/src/apriltags_ros/apriltags/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
