...
class LoggingExample:
    ...
    def __init__(self, link_uri):
        ...
        self._cf.link_status = "Unknown"
        self._cf.link_quality = 0.0
        self._cf.packetsSinceConnection = 0
        self._cf.pitch = 0.0
        self._cf.roll = 0.0
        self._cf.thrust = 0
        self._cf.yaw = 0.0
        self._cf.pub = rospy.Publisher('/crazyflie/base_link',geometry_msgs.msg.PoseStamped,queue_size=1)
